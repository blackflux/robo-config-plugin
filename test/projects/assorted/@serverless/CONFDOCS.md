...
- <a name="blackfluxrobo-config-plugin-task-idx-ref-assortedserverless">:open_file_folder:</a> <a href="#blackfluxrobo-config-plugin-task-ref-assortedserverless">`assorted/@serverless`</a>
...
### :open_file_folder: <a name="blackfluxrobo-config-plugin-task-ref-assortedserverless">assorted/@serverless</a> (<a href="#blackfluxrobo-config-plugin-task-idx-ref-assortedserverless">`index`</a>)
