- <a name="blackfluxrobo-config-plugin-task-idx-ref-assortedsls-queuejson">:open_file_folder:</a> <a href="#blackfluxrobo-config-plugin-task-ref-assortedsls-queuejson">`assorted/@sls-queue.json`</a>
